...
//
// Compared to the previous Appwrite-hosted flow this is significantly
// snappier: no browser switch, no redirect URL parsing, no "session
// already active" branching. The Google SDK is already linked into the
// binary so this ships via OTA.
