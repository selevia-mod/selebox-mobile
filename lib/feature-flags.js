 ...
 * read-side gating.)
 */
export const USE_SUPABASE_BOOKS = false;
 ...
 */
export const USE_SUPABASE_VIDEOS = false;
 ...
 * Rollback: flip back to FALSE — both code paths stay in place.
 */
export const USE_SUPABASE_NOTIFICATIONS = false;
 ...
 * Rollback: flip back to FALSE — both code paths stay in place.
 */
export const USE_SUPABASE_STORIES = false;
 ...
 */
export const USE_SUPABASE_STARS = false;
 ...
 */
export const USE_SUPABASE_USERS = false;
 ...
 */
export const USE_SUPABASE_FOLLOWS = false;
